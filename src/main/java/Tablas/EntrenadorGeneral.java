...
public class EntrenadorGeneral extends Entrenador {
    ...
    public EntrenadorGeneral(int hor_tra, String nombre, int cedula, String direccion, int telefono, String correo, int gym, Date fecha_nacimiento, char sexo, String contraseña, int sueldo) {
    ...
    public String toString() {
        return "EntrenadorGeneral{" + "nombre= " + this.getNombre() + ", cedula= " + this.getCedula() + ", direccón= " + this.getDireccion() + ", telefono= " + this.getTelefono() + ", correo= " + this.getCorreo() +
                ", gym= " + this.getGym() + ",fecha nacimiento= " + this.getFecha_nacimiento() + ", sexo= " + this.getSexo() + ", sueldo=" + this.getSueldo() + ", hor_tra=" + hor_tra + '}';
    }
